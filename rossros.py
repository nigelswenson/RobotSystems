...
default_termination_bus = Bus(False,name='terminator')
default_input_bus = Bus(name='input bus')
default_output_bus = Bus(name='output bus')
...
class ConsumerProducer:
    ...
    def __call__(self):
        ...
        while True:
            ...
            #print('these are the input values to', self.name, input_values)
            ...
            #print('these are the output values from', self.name, output_values)
